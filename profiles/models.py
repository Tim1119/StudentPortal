...
class Profile(models.Model):
    ...
    profile_pics = models.ImageField(default='avatar.png',upload_to='profile-images',validators=[FileExtensionValidator(['png','jpg','jpeg'],message='File can only be image type')])
